...
function OrderList() {
  ...
  const [ordersPerPage] = useState(20); // จำนวนรายการที่ต้องการแสดงต่อหน้า
  ...
  const pageRange = () => {
    ...
    const handleCheckOrder = () => {
        window.location = '/lineOA/ReCheckTicket'; // เปลี่ยนเป็นลิงก์ LINE ของคุณ
    };
  return (
    <div>
      <section className="bg-section">
        ...
        <button
            ...
            >
                เช็คคำสั่งซื้อตั้งแต่วันที่ 4-14 ตุลาคม 2567 ได้ที่ lineV.1
            </button>
